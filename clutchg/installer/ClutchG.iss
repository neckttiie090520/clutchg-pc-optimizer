...
;
; Output:
;   installer/output/ClutchG-Setup-1.0.2.exe
;
...
; icon.ico is generated by build.py into clutchg/build/
...
//     ClutchG-Setup-1.0.2.exe /SILENT /CLOSEAPPLICATIONS /RESTARTAPPLICATIONS
