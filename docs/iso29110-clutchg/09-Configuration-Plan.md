...
| CI-TEST-02 | Unit Tests | `clutchg/tests/unit/` | 939 tests, 34 files | สูง |
...
| Test Execution | 962 tests pass, 0 failures | nextzus | pytest HTML report + JUnit XML |
...
| Test Cases | 1026 collected (939 unit, 23 integration, 64 E2E) |
...
| Test suite passes | `pytest` | 962 passed, 0 failed (unit + integration) | PASS |
...
| 7 | Test suite passes (962 tests) | FCA | PASS |
...
| 4 | Tests pass | `pytest tests/unit tests/integration` | 962 pass, 0 fail |
