...
| CI-TEST-02 | Unit Tests | `clutchg/tests/unit/` | 1026 tests, 34 files | สูง |
...
| Test Execution | 1049 tests pass, 0 failures | nextzus | pytest HTML report + JUnit XML |
...
| Test Cases | 1113 collected (1026 unit, 23 integration, 64 E2E) |
...
| Test suite passes | `pytest` | 1049 passed, 0 failed (unit + integration) | PASS |
...
| 7 | Test suite passes (1049 tests) | FCA | PASS |
...
| 4 | Tests pass | `pytest tests/unit tests/integration` | 1049 pass, 0 fail |
