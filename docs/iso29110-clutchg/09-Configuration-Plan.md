...
| CI-TEST-02 | Unit Tests | `clutchg/tests/unit/` | 931 tests, 33 files | สูง |
...
| Test Execution | 954 tests pass, 0 failures | nextzus | pytest HTML report + JUnit XML |
...
| Test Cases | 1018 collected (931 unit, 23 integration, 64 E2E) |
...
| Test suite passes | `pytest` | 954 passed, 0 failed (unit + integration) | PASS |
...
| 7 | Test suite passes (954 tests) | FCA | PASS |
...
| 4 | Tests pass | `pytest tests/unit tests/integration` | 954 pass, 0 fail |
