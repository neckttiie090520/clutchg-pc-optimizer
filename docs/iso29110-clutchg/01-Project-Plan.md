...
| COR-04 | 2026-03 | SRS Review | SRS v2.x ไม่สะท้อน actual implementation (tweak counts, profile sizes เปลี่ยน) | อัปเดต SRS → v3.2 ตามข้อมูล ณ เวลานั้น | ⚠️ Reopened 2026-08-02 | Corrective audit found metadata/execution mismatch; see Correction Record 14 |
