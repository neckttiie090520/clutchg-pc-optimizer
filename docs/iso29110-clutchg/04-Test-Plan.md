...
| กิจกรรม | ตรวจอะไร | เทียบกับอะไร | วิธี |
|---------|---------|-------------|-----|
| Unit Testing | Individual modules | Expected behavior | pytest (1026 cases) |
...
|---|-------|----------|---------|------------|----------|
| 1 | **Unit** | Function/method เดี่ยว | Yes | 1026 | pytest + mock |
...
Measured with `python -m pytest tests/unit tests/integration --cov=src/core` from `clutchg`; 1049 tests passed.
...
| Unit Test Pass Rate | ≥ 95% | 100% (1026/1026) | EXCEEDS |
...
- **ผลลัพธ์:** 1026 unit + 23 integration test cases, pass rate 100% (measured 2026-08-05)
