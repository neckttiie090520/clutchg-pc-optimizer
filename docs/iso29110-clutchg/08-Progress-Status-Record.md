...
| Test Cases | 1133 collected (1026 unit, 23 integration, 64 E2E, 20 Batch V&V) |
| Test Pass Rate | 100% (1049 passed, 0 failed, 64 skipped headless; 20 Batch V&V TCs also 100% pass on Hyper-V Gen1) |
...
|--------|---------|---------|----------|---------|--------|
| # Tests | 0 | 49 | 49 | 1133 collected | ≥ 50 |
| Pass Rate | — | 95.9% | 95.9% | 100% (1049/1049 runnable) | ≥ 95% |
...
| R-10 | Thesis defense ไม่ผ่าน | 5 (Medium) | Mitigate | ⚠️ Monitor | — | จัดทำเอกสาร ISO 29110 ครบ 12 WPs; ทดสอบ 1049 tests; Traceability coverage 89.9%; เตรียม defense presentation |
